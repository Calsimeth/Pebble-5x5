...
Because there is no separate Android companion app, clean file import/export may be difficult or impossible within the PebbleKit JS sandbox. Import and export are aspirational capabilities and are not core acceptance criteria.
