...
mkdir "$tmp"
sources="src/c/sync.c src/c/sync_state.c src/c/sync_adapter.c src/c/sync_completion.c src/c/workout_completion.c src/c/workout_view.c src/c/rest_state.c src/c/migration.c src/c/progression.c src/c/deload.c src/c/plates.c src/c/warmups.c src/c/history_progress.c src/c/query_controller.c"
